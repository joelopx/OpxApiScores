namespace ApiScoreBoard.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ResponseModels", "RequestId", "dbo.RequestModels");
            DropForeignKey("dbo.RequestModels", "UserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.ResponseModels", new[] { "RequestId" });
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.RequestModels", new[] { "UserId" });
